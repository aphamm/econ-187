...
author: "Austin Pham (905318112), Shannan Liu (305172952)"
output: pdf_document
...
```{r}
# we can utilise cross validation to train our ridge model 
...
This shows us that our ridge model's best cross-validated performance is $29,408.71$, which is only slightly worse than our PCR model (worse by roughly $1,000$.
