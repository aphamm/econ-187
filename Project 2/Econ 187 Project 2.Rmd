...
```{r}
df = read_csv('https://raw.githubusercontent.com/onlypham/econ-187/main/Project%202/Awarded%20Grants.csv')
...
alcohol and volatile.acidity are by far the most importan variables.
